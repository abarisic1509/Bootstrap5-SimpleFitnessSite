...
})({"iot40":[function(require,module,exports) {
"use strict";
...
document.addEventListener("scroll", ()=>{
    ...
    if (scrollPosition > 1) mainHeader.classList.add("active");
    else mainHeader.classList.remove("active");
});
navbarToggler.addEventListener("click", ()=>{
    let isExpanded = navbarToggler.getAttribute("aria-expanded");
    if (isExpanded === "true") mainHeader.classList.add("active");
    else mainHeader.classList.remove("active");
});
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iot40","eAts2"], "eAts2", "parcelRequire5f8e")
